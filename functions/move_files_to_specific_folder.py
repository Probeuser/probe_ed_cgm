...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    try:
        ...
        main_folder_path = r"C:\inetpub\wwwroot\Sebi_apiproject\pdfdownload\ed_cgm" # file path with order type
        ...
        def save_to_excel():
            ...
            final_excel_sheets_path = fr"C:\Users\devadmin\sebi_final_script\ed_cgm\data\final_excel_sheets\{final_excel_sheets_name}"
