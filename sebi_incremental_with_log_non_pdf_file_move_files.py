...
download_folder = r"C:\Users\mohan.7482\Desktop\sebi_final_script\pdfdownload"
# C:\Users\mohan.7482\Desktop\sebi_final_script\pdfdownload\ed_cgm
...
def get_data_count(log_cursor):
    log_cursor.execute("SELECT COUNT(*) FROM sebi_orders  WHERE type_of_order = 'ed_cgm';")
...
def insert_excel_data_to_mysql(final_excel_sheets_path, cursor):
    ...
    try:
        ...
        log_list = [None] * 8
        traceback.print_exc()
        send_email("SEBI ed_cgm order script error", e)
...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    ...
    try:
        ...
        main_folder_path = r"C:\Users\mohan.7482\Desktop\sebi_final_script\pdfdownload\ed_cgm"
        ...
        def save_to_excel():
            ...
            final_excel_sheets_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\ed_cgm\final_excel_sheets\{final_excel_sheets_name}"
        ...
        def move_files(selected_month_rows, year_folder_path, month, year):
            for row in selected_month_rows:
                ...
                _,_,relative_path = new_file_path.partition('sebi_final_script')
            ...
            if shadow_element:
                ...
                if print_preview_app :
                    ...
                    if shadow_element:
                        ...
                        shadow_element.click()
                        time.sleep(10)
                        file_name_with_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\pdfdownload\ed_cgm_{name}_{index}.pdf"
                        ...
                        return f"ed_cgm_{name}_{index}.pdf"
                else:
...
def download_pdf_files(df, type_sebi_text):
    ...
    file_name_excel_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\ed_cgm\file_name_excel_sheets\{excel_with_final_name}"
...
def find_new_data(excel_file_path, db_table_name, type_sebi_text):
    ...
    try:
        ...
        select_query = f"SELECT link_to_order FROM {db_table_name} WHERE type_of_order = 'ed_cgm';"
        ...
        new_excel_file_path = rf"C:\Users\mohan.7482\Desktop\sebi_final_script\ed_cgm\incremental_excel_sheets\Missing_Data_{type_sebi_text}_{current_date}.xlsx"
...
def extract_data_website(cursor):
    ...
    try:
        ...
        type_sebi= WebDriverWait(browser, 30).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="member-wrapper"]/section/div/ul/li[9]/a'))
            )
        # type_sebi_text = type_sebi.get_attribute('innerText')
        type_sebi_text = "ed_cgm"
        ...
        excel_file_path = rf"C:\Users\mohan.7482\Desktop\sebi_final_script\ed_cgm\first_set_excel_sheet_files\{excel_file_name}"
