...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    ...
    main_folder_path = r"C:\inetpub\wwwroot\Sebi_apiproject\pdfdownload\ed_cgm"
    ...
    def save_to_excel():
        ...
        final_excel_sheets_path = fr"C:\Users\devadmin\sebi_final_script\ed_cgm\final_excel_sheets\{final_excel_sheets_name}"
    ...
    def move_files(selected_month_rows, year_folder_path, month, year):
        for row in selected_month_rows:
            ...
            if pd.isna(file):
                ...
                _,_,relative_path = new_file_path.partition('ed_cgm')
            ...
            if shadow_element:
                ...
                if print_preview_app :
                    ...
                    if shadow_element:
                        ...
                        shadow_element.click()
                        time.sleep(10)
                        file_name_with_path = fr"C:\Users\devadmin\sebi_final_script\pdfdownload\ed_cgm\ed_cgm_{name}_{index}.pdf"
...
def download_pdf_files(df, type_sebi_text):
    ...
    file_name_excel_path = fr"C:\Users\devadmin\sebi_final_script\ed_cgm\file_name_excel_sheets\{excel_with_final_name}"
...
def find_new_data(excel_file_path, db_table_name, type_sebi_text):
    ...
    try:
        ...
        select_query = f"SELECT {', '.join(columns_to_select)} FROM {db_table_name} WHERE type_of_order = 'ed_cgm';"
        ...
        if not missing_rows.empty:
            ...
            print(missing_rows)
            new_excel_file_path = rf"C:\Users\devadmin\sebi_final_script\ed_cgm\incremental_excel_sheets\Missing_Data_{type_sebi_text}{current_date}.xlsx"
...
def extract_data_website(cursor):
    ...
    try:
        ...
        excel_file_path = rf"C:\Users\devadmin\sebi_final_script\ed_cgm\first_set_excel_sheet_files\{excel_file_name}"
